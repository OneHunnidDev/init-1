...
!define URL http://www.Nocturna.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Nocturna.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Nocturna-qt.exe
...
OutFile Nocturna-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Nocturna-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Nocturnad.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Nocturna.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Nocturna-qt.exe
