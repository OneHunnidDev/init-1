...
unsigned int nTargetSpacing     = 120;               // 2 mins
...
const string strMessageMagic = "Nocturna Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if(nHeight >= 1000 && nHeight < 1250)
    {
        nSubsidy = 3.125 * COIN;
    }
    else if(nHeight >= 1250 && nHeight < 1500)
    {
        nSubsidy = 1.6 * COIN;
    }
    else if(nHeight >= 1500 && nHeight < 1750)
    {
        nSubsidy = 0.8 * COIN;
    }
    else if(nHeight >= 1750 && nHeight < 2000)
    {
        nSubsidy = 0.4 * COIN;
    }
    else if(nHeight >= 2000 && nHeight < 2250)
    {
        nSubsidy = 0.2 * COIN;
    }
    else if(nHeight >= 2250)
    {
        nSubsidy = 0.1 * COIN;
    }
...
// Nocturna: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Nocturna", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        const char* pszTimestamp = "Nocturna 2015 start!";
        CTransaction txNew;
        txNew.nTime = 1436561188;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x53c1d84f871f2525633ed93463a3aa0395b99e6c82c181cc42ba470a4ded2f12"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0x11, 0x77, 0xfa };
